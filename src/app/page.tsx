...
export default async function Home() {
  ...
  //     setIsLoading(true)
  //     try {
  //       const res = await axios.get('/api/isha');
  //       const data = await res?.data?.data?.allLandingPages[0]
  //       setData(data)
  //       setIsLoading(false)
  //     } catch (err: any) {
  //       console.log("Err while getting data", err)
  //       setIsLoading(false)
  //       throw new Error("Err while getting data", err)
  //     }
  //   }
  //   fetchData();
  // }, [])
